...
interface DelegatableVaultStorageV2Interface extends ethers.utils.Interface {
  functions: {
...
export class DelegatableVaultStorageV2 extends BaseContract {
  ...
  interface: DelegatableVaultStorageV2Interface;
