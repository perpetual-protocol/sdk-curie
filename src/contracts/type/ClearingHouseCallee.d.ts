...
interface ClearingHouseCalleeInterface extends ethers.utils.Interface {
  functions: {
...
export class ClearingHouseCallee extends BaseContract {
  ...
  interface: ClearingHouseCalleeInterface;
